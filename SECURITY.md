...
Only the **latest released version** of `GroupDocs.Metadata.Mcp` (NuGet / GHCR / Docker Hub)
...
- Use GitHub's [private vulnerability reporting](https://github.com/groupdocs-metadata/GroupDocs.Metadata.Mcp/security/advisories/new)
...
- Vulnerabilities in the underlying `GroupDocs.Metadata` engine (a closed-source NuGet
