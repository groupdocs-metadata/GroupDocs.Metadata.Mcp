...
Thanks for your interest in improving the GroupDocs.Metadata MCP server.
...
`.vscode/mcp.json` contains a `groupdocs-metadata-dev` entry that runs the server from
...
Use the [issue templates](https://github.com/groupdocs-metadata/GroupDocs.Metadata.Mcp/issues/new/choose).
