...
public class GetDocumentInfoToolTests
{
    ...
    {
        // The resolver call sits outside the tool's try/catch, so resolution
        // failures propagate rather than being folded into the descriptive
        // "Document-info lookup failed for" text (which is reserved for engine errors).
        _resolver
