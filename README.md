...
```bash
dnx GroupDocs.Metadata.Mcp@26.9.0 --yes
```
...
> `"GroupDocs.Metadata.Mcp@26.9.0"` in `args`. Pinning is recommended for
...
> `"GroupDocs.Metadata.Mcp@26.9.0"` to lock to a specific release.
